...
class Advertisements(models.Model):
    ...
    def __str__(self):
            return f"Advertisement(id={self.id}, title={self.title}, price={self.price})" # магический метод str - возвращает текущий обьект

    class Meta:
        db_table = "advertisements" # класс, которы позволяет внести изменения в какой-то уже существующий класс
